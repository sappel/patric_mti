...
machines=['lxir045','lxir057','lxir058','lxir045','lxir045']   #49, 53, 54, 55, 56, 58, 59, 60, 61, 66 
machines=machines*8   
...
patric_dict['rms_emittance_x0']=ex0/4.  # rms, mm mrad
...
patric_dict['offcenter']=0.08   #BumpA-BumpA/Bumpf*ChopV
patric_dict['inj_angle']=7e-3  # injection angle in rad; added by SP
...
while exmin <= exmax:
	...
	patric_dict['rms_emittance_x0']=exmin/4.
