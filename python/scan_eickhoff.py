...
machines=['lxir053','lxir053','lxir058','lxir053','lxir053']   #49, 53, 54, 55, 56, 58, 59, 60, 61, 66 
machines=machines*8   
...
Bumpf0=40; dBumpf=40; Bumpfmax=80
path='/d/bhs01/appel/patric'  # path for output
expath='/u/sappel/codes/patric_mti'  # base directory of code
subdir = '/eickhoff/neu_nsp/ex_2/'  

Amp0=BumpA-BumpA/Bumpf0*ChopV
delAmp =(BumpA/Bumpf0/1e-6*t_turn)     
mtj=int(floor(Bumpf0*1e-6/t_turn))        
...
patric_dict['offcenter']=0.077   #BumpA-BumpA/Bumpf*ChopV
...
patric_dict['print_cell']=20  # with MADX input one cell is the whole lattice
...
while Bumpfmin <= Bumpfmax:
	...
	patric_dict['delAmp']=(BumpA/Bumpfmin/1e-6*t_turn)  
	patric_dict['max_inj']=int(floor(Bumpfmin*1e-6/t_turn))      
