...
machines=['lxir059','lxir053','lxir058','lxir045','lxir045']#,'lxir050']    #49, 53, 54, 55, 56, 58, 59, 60, 61, 66 
machines=machines*8   

# Flexibity
bumpI = 1
Bumpf = 160e-6          #single 100 10turns 160
BumpA = 85e-3
Chopf = 55e-6
...
Qvec=3.30
# Qhor
q=4.02;  dq=0.02; qmax=4.33  
path='/d/bhs01/appel/patric/orbit_test'  # path for output
...
patric_dict['Z']=39.0
patric_dict['A']=238.0
patric_dict['current']=20e-6 # [A]
patric_dict['piperadius']=0.15
...
patric_dict['offcenter']=0.077#BumpA-BumpA/Bumpf*ChopV          70+-20mm
patric_dict['inj_angle']=7.e-3  # injection angle in rad; added by SP  6+-2mrad
...
while qmin <= qmax:
	...
	os.chdir(expath+"/mad/")         
	cmd='sed -ie "s/Q_hor = .*/Q_hor = %1.2f;/" sis18_inj4.mad;' %(qmin) 
	os.system(cmd)
	cmd='sed -ie "s/Q_vec = .*/Q_vec = %1.2f;/" sis18_inj4.mad;' %(Qvec) 
	os.system(cmd)   
	os.system("/u/sappel/.madx/madx < sis18_inj4.mad >out.madx.dat")
	shutil.copy("/u/sappel/codes/patric_mti/mad/sis18_inj4.mad", path+subdir+scan+"/")
	shutil.copy("/u/sappel/codes/patric_mti/mad/out.madx.dat", path+subdir+scan+"/")   
	shutil.copy("/u/sappel/codes/patric_mti/mad/madx.ps", path+subdir+scan+"/")   	
	os.chdir("../python/")
